...
const editArticleFeature = createFeature({
  ...
  reducer: createReducer(
    ...
    on(editArticleActions.getArticleFaliure, (state,) => ({
      ...state,
      isLoading: false,
    })),
    ...
    on(editArticleActions.updateArticleFaliure,(state,action)=>({...state,isSubmitting:false,validationErrors:action.errors})),
